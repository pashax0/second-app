...
-- Drop #1 — дополнительные товары (итого 10)

  (
    '11111111-0000-0000-0000-000000000013',
    'Джинсы прямые',
    'Wrangler', 'USA', 'M',
    '{"waist":38,"hips":48,"length":108}',
    '213', 2490.00, 0
  ),
  (
  ...
  (
    ...
    'Блузка принт',
    'River Island', 'England', 'S',
    '{"chest":46,"length":55}',
    '218', 1490.00, 0
  ),

-- Drop #2 (PLT) — дополнительные товары (итого 10)
  ...
  (
    ...
    'Свитшот с капюшоном',
    'Pretty Little Thing', 'England', 'XL',
    '{"chest":62,"length":72}',
    '223', 2490.00, 0
  ),
  (
...
-- Drop #3 (активный) — дополнительные товары (итого 10)
